...
export const questions: readonly Question[] = [
  { key: 'taste', label: '맛', title: '오늘은 어떤 맛이 끌리세요?', options: [
    ['SWEET', '달콤하게', '🍯'], ['SOUR', '새콤상큼하게', '🍋'], ['BITTER', '쌉싸름하게', '🌿'], ['BALANCED', '달콤하고 새콤하게', '⚖️'], ['UNKNOWN', '잘 모르겠어요', '🤔'],
  ] },
  ...
  { key: 'occasion', label: '순간', title: '어떤 순간에 마실 예정인가요?', options: [
    ['PARTY', '친구들과 즐길 때', '🎉'], ['MEAL', '음식과 함께', '🍽️'], ['DESSERT', '디저트처럼', '🍰'], ['SLOW', '천천히 한 잔', '🌙'],
    ['REFRESH', '시원하게 기분전환', '☀️'], ['APERITIF', '식사 전에', '🥂'], ['BRUNCH', '브런치와 함께', '🌤️'], ['UNKNOWN', '아직 정하지 않았어요', '🤔'],
  ] },
